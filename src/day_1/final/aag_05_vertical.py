...
form = FormDiagram.from_json('aag_04_formdiagram_horizontal.json')
force = ForceDiagram.from_json('aag_04_forcediagram_horizontal.json')
...
form.to_json('aag_05_formdiagram_vertical.json')
force.to_json('aag_05_forcediagram_vertical.json')
